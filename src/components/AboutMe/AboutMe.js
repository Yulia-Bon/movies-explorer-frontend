      ...
      <div className="about-me__container">
        ...
        <div className="about-me__description">
          ...
          <ul className="social-networks">
            <li>
              <a className="social-networks__link hover-link" href="https://www.linkedin.com/in/yulia-bon" target="blank">LinkedIn</a>
            </li>
            <li>
              <a className="social-networks__link hover-link" href="https://github.com/Yulia-Bon" target="blank">Github</a>
            </li>
          </ul>
        </div>
