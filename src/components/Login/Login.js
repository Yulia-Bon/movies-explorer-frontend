                ...
                <fieldset className="form__container">
                    ...
                    <div className="form__input-container">
                        ...
                        <span id="email-input-error"
                              className={errors.name ? 'form__error form__error_active email-input-error' : 'form__error'}></span>
                    </div>
                    ...
                    <div className="form__input-container">
                        ...
                        <span id="password-input-error"
                              className={errors.name ? 'form__error form__error_active password-input-error' : 'form__error'}></span>
                    </div>
